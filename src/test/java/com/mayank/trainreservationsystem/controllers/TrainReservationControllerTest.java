...
class TrainReservationControllerTest {
    ...
    void testPing() {
        ...
        TicketBookingRequest ticketBookingRequest =
                TicketBookingRequest.builder().build();
        ...
        IntStream.range(0, 60)
                .forEach(i -> {
                    ticketBookingRequest.setUserInfo(BookingUserInfo.builder()
                            .firstName("firstName" + i + 1)
                            .lastName("lastName" + i + 1)
                            .emailId("email" + i + 1 + "@gmail.com")
                            .build());

                    ResponseEntity<TicketBookingResponse> responseEntity = testRestTemplate.postForEntity(uri, httpEntity, TicketBookingResponse.class);
        ...
        ResponseEntity<TicketBookingResponse> responseEntity1 = testRestTemplate.postForEntity(uri, httpEntity, TicketBookingResponse.class);
        ...
        ResponseEntity<TicketBookingResponse> responseEntity2 = testRestTemplate.postForEntity(uri, httpEntity, TicketBookingResponse.class);
